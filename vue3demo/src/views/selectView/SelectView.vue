...
<template>
  <div>
    <el-form ref="selectFormRef" :inline="true" :rules="rules" :model="selectForm" label-width="auto">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template v-slot="scope">
          ...
          <el-button @click="dialog(scope.row)" type="primary" size="small">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
